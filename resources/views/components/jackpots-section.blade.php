                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-700 transition-all duration-300 hover:shadow-amber-500/20 hover:transform hover:scale-[1.02]">
                        ...
                        <div class="p-4">
                            ...
                            <a href="https://play.google.com/store/apps/details?id=com.topfootballapp.mobile" class="block text-center py-2 px-4 bg-gray-700 hover:bg-gray-600 text-white rounded-lg font-medium transition-all duration-300 text-sm">
                                View Predictions
                            </a>
                        </div>
                    </div>
